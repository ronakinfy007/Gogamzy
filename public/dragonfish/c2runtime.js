...
(function() {
    ...
    c.prototype.ts = function(a) {
        ...
        for (l = 0; 4 > l; l++)
            for (h = 0; 4 > h; h++)
                if (b = this.Jg(l, !0), c = this.Jg(l, !1), g = this.Jg(l + 1, !0), d = this.Jg(l + 1, !1), e = a.Jg(h, !0), k = a.Jg(h, !1), f = a.Jg(h + 1, !0), m = a.Jg(h + 1, !1), wa(b, c, g, d, e, k, f, m)) return !0;
        return !1
    };
    ya = c;
    Ba = function(a, b) {
    ...
    d.prototype.remove = function(a) {
        if (!this.ag())
            if (D) this.Ef.has(a) && (this.Ef["delete"](a), this.Lg = !1);
            else if (this.items) {
            a = a.toString();
            var b = this.items;
    ...
    e.prototype.jk = function(a, b, c) {
        ...
        e = 0;
        for (l = this.oe; e < l; e++)
            for (k = 2 * e, f = (e + 1) % l * 2, p = d[k], k = d[k + 1], q = d[f], r = d[f + 1], f = 0, n = a.oe; f < n; f++)
                if (m = 2 * f, h = (f + 1) % n * 2, t = g[m] + b, m = g[m + 1] + c, z = g[h] + b, h = g[h + 1] + c, wa(p, k, q, r, t, m, z, h)) return !0;
        return !1
    };
    Ab = e;
    ...
    g.prototype.update = function(a, b, c) {
        ...
        if (b)
            for (g = b.left, d = b.right; g <= d; ++g)
                for (e = b.top, k = b.bottom; e <= k; ++e)
                    if (!c || !c.gd(g, e))
                        if (f = this.Vg(g, e, !1)) f.remove(a), f.ag() && (f.Lc.clear(), 1E3 > E.length && E.push(f), this.cells[g][e] = null);
        if (c)
            for (g = c.left, d = c.right; g <= d; ++g)
                for (e = c.top, k = c.bottom; e <= k; ++e) b && b.gd(g, e) || this.Vg(g, e, !0).lp(a)
    };
    g.prototype.nn = function(a, b) {
        ...
        d = this.Cd(a.top);
        g = this.Bd(a.right);
        for (k = this.Cd(a.bottom); c <= g; ++c)
            for (e = d; e <= k; ++e)(f = this.Vg(c, e, !1)) && f.dump(b)
    };
    Bb = g;
    ...
    l.prototype.update = function(a, b, c) {
        ...
        if (b)
            for (g = b.left, d = b.right; g <= d; ++g)
                for (e = b.top, k = b.bottom; e <= k; ++e)
                    if (!c || !c.gd(g, e))
                        if (f = this.Vg(g, e, !1)) f.remove(a), f.ag() && (f.reset(), 1E3 > w.length && w.push(f), this.cells[g][e] = null);
        if (c)
            for (g = c.left, d = c.right; g <= d; ++g)
                for (e = c.top, k = c.bottom; e <= k; ++e) b && b.gd(g, e) || this.Vg(g, e, !0).lp(a)
    };
    l.prototype.nn = function(a, b, c, g, d) {
        ...
        b = this.Cd(b);
        c = this.Bd(c);
        for (e = this.Cd(g); a <= c; ++a)
            for (g = b; g <= e; ++g)(k = this.Vg(a, g, !1)) && k.dump(d)
    };
...
function kd(a, c, b, d) {
    ...
    d.prototype.Yw = function() {
        ...
        if (c.Oa.length)
            for (a = 0, b = c.Oa.length; a < b; a++) e = this.du[a], e !== c.yp[a] && (c.yp[a] = e, d.uniform1f(c.Oa[a][1], e))
    };
    ...
    a.prototype.sj = function(a, b, c, d, e, f, h, t, u, v, r, z, B, D, A) {
        ...
        if (C.Jy || A.length) {
            ...
            if (A.length)
                for (c = E.du, c.length = A.length, a = 0, b = A.length; a < b; a++) c[a] = A[a];
            this.jd = !1
        }
    };
...
(function() {
    ...
    b.prototype.Ny = function() {
        ...
        if (this.ga) {
            ...
            e = 0;
            for (d = this.da.length; e < d; e++)
                for (k = this.da[e], f = 0, g = k.Da.length; f < g; f++) m = k.Da[f], m.nc = this.ja.Yo(m.id), m.bf = this.ja.mq(m.nc), this.Aj = this.Aj || this.ja.Pk(m.nc);
            e = 0;
    ...
    b.prototype.setSuspended = function(a) {
        var b;
        if (a && !this.pk)
            for (fa("[Construct 2] Suspending"), this.pk = !0, -1 !== this.oq && k && k(this.oq), -1 !== this.Jq && clearTimeout(this.Jq), a = 0, b = this.bl.length; a < b; a++) this.bl[a](!0);
        else if (!a && this.pk) {
    ...
    b.prototype.Mm = function(a) {
        ...
        for (c = a[3].length; b < c; b++) {
            ...
            for (d = this.plugins.length; e < d; e++)
                if (this.plugins[e] instanceof f) {
                    h = this.plugins[e];
                    break
                }
            m = new h.Va(h);
            ...
            for (d = k[8].length; e < d; e++) {
                ...
                q = null;
                f = 0;
                for (g = this.gc.length; f < g; f++)
                    if (this.gc[f] instanceof l) {
                        q = this.gc[f];
                        break
                    }
        ...
        for (c = a[4].length; b < c; b++)
            for (f = a[4][b], g = this.da[f[0]], e = 1, d = f.length; e < d; e++) k = this.da[f[e]], k.Jb.push(g), g.jj.push(k);
        b = 0;
        ...
        if (0 < this.Xj)
            for (b = 0, c = this.da.length; b < c; b++)
                if (k = this.da[b], !k.Ea && k.Jb.length) {
                    k.cm = Array(this.Xj);
                    k.Pi = Array(this.Xj);
                    k.Xr = Array(this.Xj);
                    m = [];
                    e = q = l = p = 0;
                    for (d = k.Jb.length; e < d; e++)
                        for (h = k.Jb[e], k.cm[h.Wf] = p, p += h.pA, k.Pi[h.Wf] = l, l += h.rw, k.Xr[h.Wf] = q, q += h.Zx, f = 0, g = h.Da.length; f < g; f++) m.push(Ba({}, h.Da[f]));
                    k.Da = m.concat(k.Da);
                    e = 0;
    ...
    b.prototype.Wx = function(a) {
        var b, c;
        b = 0;
        for (c = this.Dj.length; b < c; b++)
            if (this.Dj[b].Dw === a) return this.Dj[b];
        return null
    };
    var q = 0,
        p = !1;
    ...
    b.prototype.jx = function(a) {
        if (!t) {
            for (var b = Math.ceil(this.width), c = Math.ceil(this.height), e = this.bh.Rm, f = this.bh.wz, g = this.bh.qA, k = 0; 4 > k; ++k)
                if (!e[k].complete || !f[k].complete || !g[k].complete) return;
            0 === w && (u = Date.now());
            var k = Date.now(),
                h = !1,
                p = a,
    ...
    b.prototype.Hy = function() {
        ...
        var a, b, c;
        if (this.Tq)
            for (a = 0, b = this.da.length; a < b; a++) c = this.da[a], c.Ea || c.qp || !c.pb.ah || c.qa();
        else this.tk = !1;
        a = 0;
    ...
    b.prototype.cz = function(a) {
        ...
        for (b = this.da.length; a < b; a++)
            if (g = this.da[a], !g.Ea && (g.gc.length || g.Jb.length))
                for (c = 0, e = g.G.length; c < e; c++)
                    for (k = g.G[c], d = 0, f = k.Ca.length; d < f; d++) k.Ca[d].Sb();
        a = 0;
        for (b = this.da.length; a < b; a++)
            if (g = this.da[a], !g.Ea && (g.gc.length || g.Jb.length))
                for (c = 0, e = g.G.length; c < e; c++)
                    for (k = g.G[c], d = 0, f = k.Ca.length; d < f; d++) h = k.Ca[d], h.vz && h.vz();
        c = this.Tp.jf();
        a = 0;
        ...
        for (b = this.da.length; a < b; a++)
            if (g = this.da[a], !g.Ea && (g.gc.length || g.Jb.length))
                for (c = 0, e = g.G.length; c < e; c++)
                    for (k = g.G[c], d = 0, f = k.Ca.length; d < f; d++) h = k.Ca[d], h.Gn && h.Gn();
        c = this.Up.jf();
        a = 0;
    ...
    b.prototype.nj = function() {
        ...
        for (b = this.da.length; a < b; a++)
            if (g = this.da[a], !g.Ea)
                for (c = 0, e = g.G.length; c < e; c++)
                    if (k = g.G[c], k.nj && k.nj(), k.Ca)
                        for (d = 0, f = k.Ca.length; d < f; d++) h = k.Ca[d], h.nj && h.nj()
    };
    b.prototype.Vr = function(a) {
        ...
        var c, e, d, f, g, k, h;
        if (this.ja)
            for (c = 0, e = this.da.length; c < e; c++) g = this.da[c], g.Ea || !g.Pq || g.global && 0 !== g.G.length || -1 !== a.ik.indexOf(g) || g.Pq();
        b == a && J(this.Gf.Qd);
        J(this.Sk);
        a.Eq();
        c = 0;
        for (e = this.da.length; c < e; c++)
            if (g = this.da[c], g.global || g.pb.zn)
                for (a = 0, b = g.G.length; a < b; a++)
                    if (k = g.G[a], k.Xp && k.Xp(), k.Ca)
                        for (d = 0, f = k.Ca.length; d < f; d++) h = k.Ca[d], h.Xp && h.Xp();
        this.Ta = !0;
        this.ed()
    };
    ...
    b.prototype.Eg = function(a) {
        ...
        this.Xg = !0;
        if (a.td)
            for (b = 0, c = a.siblings.length; b < c; b++) this.Eg(a.siblings[b]);
        this.pp && e.Bj.push(a);
    ...
    b.prototype.ed = function() {
        if (this.Xg) {
            ...
            for (d = this.We.length; c < d; ++c)
                for (a = this.We[c], b = a.type, b.G.push(a), e = 0, f = b.Jb.length; e < f; ++e) b.Jb[e].G.push(a), b.Jb[e].vj = !0;
            J(this.We);
            this.gv();
            pb(this.Lh);
            this.Xg = this.pp = !1
    ...
    b.prototype.Pu = function(a) {
        ...
        e = 0;
        for (d = this.Gf.Qd.length; e < d; ++e)
            if (k = this.Gf.Qd[e], k.yd.hasOwnProperty(c.index) && rb(k.yd[c.index].$f, a), !c.Ea)
                for (f = 0, g = c.Jb.length; f < g; ++f) h = c.Jb[f], k.yd.hasOwnProperty(h.index) && rb(k.yd[h.index].$f, a);
        if (k = b[0].V) {
            if (k.te)
                for (f = k.G, e = 0, d = f.length; e < d; ++e) g = f[e], a.contains(g) && (g.Ua(), k.$c.update(g, g.Nd, null), g.Nd.set(0, 0, -1, -1));
            rb(k.G, a);
            k.Vk(0)
        }
    ...
    b.prototype.Ou = function(a, b) {
        ...
        (c = a.V) && c.pj(a, !0);
        if (a.Ca)
            for (c = 0, e = a.Ca.length; c < e; ++c) d = a.Ca[c], d.Lk && d.Lk(), d.behavior.Um.remove(a);
        this.kt.remove(a);
        this.Tp.remove(a);
        this.Up.remove(a);
        a.Lk && a.Lk();
    ...
    b.prototype.Qg = function(a, b, c, e, d, f) {
        ...
        if (r.pe) pb(r.fa);
            ...
            if ("undefined" !== typeof cr_is_preview)
                for (r.ss = [], r.ss.length = h.length, g = 0, k = h.length; g < k; g++) r.ss[g] = h[g][1];
            r.yc = [];
        ...
        if (l) {
            ...
            if (r.pe) {
                ...
                for (k = n[12].length; g < k; g++)
                    for (h = 0, m = n[12][g].length; h < m; h++) r.Kb[g][h] = n[12][g][h];
                r.Ab.set(0, 0, 0, 0);
                r.Pg.set(0, 0, -1, -1);
                r.Nd.set(0, 0, -1, -1);
                r.Bb.Wk(r.Ab);
        ...
        if (r.pe)
            for (g = 0, k = K.length; g < k; g++) {
                ...
                for (r.Ca = [], g = 0, k = K.length; g < k; g++) z = K[g], t = new z.behavior.Ja(z, r), t.pe = !1, t.ca = a[4][g].slice(0), t.qa(), r.Ca.push(t), z.behavior.Um.add(r);
        n = a[5];
        if (r.pe)
            for (g = 0, k = n.length; g < k; g++) r.ca[g] = n[g];
        else r.ca = n.slice(0);
        this.We.push(r);
        this.Xg = !0;
        ...
        if (p.td) {
            if (r.td = !0, r.pe ? J(r.siblings) : r.siblings = [], !c && !f) {
                g = 0;
                for (k = p.Ud.length; g < k; g++)
                    if (p.Ud[g] !== p) {
                        if (!p.Ud[g].Be) return null;
                        r.siblings.push(this.Qg(p.Ud[g].Be, q, !1, l ? r.x : e, l ? r.y : d, !0))
                    }
                g = 0;
                for (k = r.siblings.length; g < k; g++)
                    for (r.siblings[g].siblings.push(r), h = 0; h < k; h++) g !== h && r.siblings[g].siblings.push(r.siblings[h])
            }
    ...
    b.prototype.So = function(a, b, c, e) {
        ...
        if (b.Ea)
            for (a = 0, d = b.jj.length; a < d; ++a) g = b.jj[a], f || g.yl ? Ia(e, g.G) : (this.Du(g), g.Ml.nn(c, e));
    ...
    b.prototype.cl = function(a, b, c) {
        var e = a.Ma(),
            d, g, f, k, h, m;
        if (e.bb)
            for (e.bb = !1, J(e.G), d = 0, k = a.G.length; d < k; d++) f = a.G[d], f.Ua(), h = f.V.Vb(b, c, !0), m = f.V.Vb(b, c, !1), f.gd(h, m) && e.G.push(f);
        else {
            d = g = 0;
    ...
    b.prototype.qu = function(a, b) {
        ...
        for (e = P.length; c < e; ++c)
            if (d = P[c], g = d.Fz, f.Py(g, k, h) && (H.Wk(g), H.offset(k, h), H.ts(b.Bb)))
                if (m)
                    if (b.Ra.Jh(b.width, b.height, b.M), d.Bf) {
    ...
    b.prototype.zu = function(a, b) {
        ...
        var c, e, d, g, f;
        c = 0;
        for (e = a.gc.length; c < e; c++)
            if (a.gc[c].behavior instanceof b) return !0;
        if (!a.Ea)
            for (c = 0, e = a.Jb.length; c < e; c++)
                for (f = a.Jb[c], d = 0, g = f.gc.length; d < g; d++)
                    if (f.gc[d].behavior instanceof b) return !0;
        return !1
    };
    ...
    b.prototype.si = function(a) {
        ...
        for (c = O.length; b < c; ++b)
            if (e = O[b], e.fa.solidEnabled && this.sh(a, e)) return J(O), e;
        J(O);
        return null
    };
    b.prototype.Dz = function(a, b, c, e) {
        ...
        var d = a.x,
            ...
            h = null;
        for (f = 0; f < e; f++)
            if (a.x = d + b * f, a.y = g + c * f, a.ra(), !this.sh(a, k) && ((k = this.si(a)) && (h = k), !k && !k)) return h && this.Bz(a, b, c, h), !0;
        a.x = d;
        a.y = g;
        a.ra();
        return !1
    ...
    b.prototype.yw = function(a, b) {
        var c, e, d;
        c = 0;
        for (e = this.Sk.length; c < e; c++)
            if (d = this.Sk[c], d[0] == a && d[1] == b || d[0] == b && d[1] == a) return !0;
        return !1
    };
    b.prototype.ww = function(a, b, c) {
        ...
        var h = k,
            m, p, r, l, q = Na(5);
        for (m = 1; 36 > m; m++)
            if (p = f - m * q, a.x = b + Math.cos(p) * g, a.y = c + Math.sin(p) * g, a.ra(), !this.sh(a, h) && (h = this.si(a), !h)) {
                r = p;
                break
            }
        36 === m && (r = Ra(f + sa));
    ...
    b.prototype.wu = function(a, b, c, e) {
        var d = !1,
            g, f, k, h;
        if (b)
            for (k = this.Lq(a, b, b.type.name, c, e), d = d || k, h = b.type.Jb, g = 0, f = h.length; g < f; ++g) k = this.Lq(a, b, h[g].name, c, e), d = d || k;
    ...
    b.prototype.gs = function(a, b) {
        for (var c, e, d, g, f, k; b;) {
            c = 0;
            for (e = b.Pe.length; c < e; c++)
                if (k = b.Pe[c], k instanceof zc && Sb(a, k.name)) return k;
            b = b.parent
        }
        c = 0;
        for (e = this.Vf.length; c < e; c++)
            for (f = this.Vf[c], d = 0, g = f.Tg.length; d < g; d++)
                if (k = f.Tg[d], k instanceof zc && Sb(a, k.name)) return k;
        return null
    };
    b.prototype.hs = function(a) {
        ...
        for (c = this.$e.length; b < c; b++)
            if (this.$e[b].Xa === a) return this.$e[b];
        return null
    };
    b.prototype.qm = function(a) {
        ...
        for (c = this.da.length; b < c; b++)
            if (this.da[b].Xa === a) return this.da[b];
        return null
    };
    b.prototype.fy = function(a) {
        var b, c;
        b = 0;
        for (c = this.Ei.length; b < c; b++)
            if (this.Ei[b].Xa === a) return this.Ei[b];
        return null
    };
    ...
    b.prototype.Rt = function() {
        ...
        for (b = this.da.length; a < b; a++)
            if (c = this.da[a], !c.Ea)
                for (e = 0, d = c.G.length; e < d; e++) f = c.G[e], this.ig[f.uid.toString()] = f
    };
    b.prototype.az = function(a) {
        ...
        if (a.c2save && !(1 < a.version)) {
            ...
            if (c !== this.qb.Xa)
                if (c = this.hs(c)) this.Vr(c);
                else return;
            var e, d, f, g, k, h, m;
            h = a.types;
            for (d in h)
                if (h.hasOwnProperty(d) && (g = this.qm(parseInt(d, 10))) && !g.Ea && !this.Nq(g)) {
            ...
            c = 0;
            for (e = this.da.length; c < e; c++)
                if (g = this.da[c], !g.Ea && !this.Nq(g))
                    for (d = 0, a = g.G.length; d < a; d++) {
                        k = g.G[d];
                        if (g.td)
                            for (h = k.ek(), J(k.siblings), b = 0, f = g.Ud.length; b < f; b++) m = g.Ud[b], g !== m && k.siblings.push(m.G[h]);
                        k.Lf && k.Lf();
                        if (k.Ca)
                            for (b = 0, f = k.Ca.length; b < f; b++) h = k.Ca[b], h.Lf && h.Lf()
                    }
            this.Ta = !0
        }
    };
    b.prototype.xq = function(a, b) {
        ...
        ib(a.fa) && (k.ex = l(a.fa));
        if (a.yc && a.yc.length)
            for (k.ivs = {}, c = 0, e = a.yc.length; c < e; c++) k.ivs[a.type.mp[c].toString()] = a.yc[c];
        if (d.ah) {
            d = {
                x: a.x,
                y: a.y,
            ...
            if (f.Da.length)
                for (d.fx = [], c = 0, e = f.Da.length; c < e; c++) g = f.Da[c], d.fx.push({
                    name: g.name,
                    active: a.Ig[g.index],
                    params: a.Kb[g.index]
                });
        ...
        if (a.Ca && a.Ca.length)
            for (k.behs = {}, c = 0, e = a.Ca.length; c < e; c++) f = a.Ca[c], f.Nc && (k.behs[f.type.Xa.toString()] = f.Nc());
        a.Nc && (k.data = a.Nc());
        return k
    };
    b.prototype.hy = function(a, b) {
        var c, e;
        c = 0;
        for (e = a.mp.length; c < e; c++)
            if (a.mp[c] === b) return c;
        return -1
    };
    b.prototype.by = function(a, b) {
        var c, e;
        c = 0;
        for (e = a.Ca.length; c < e; c++)
            if (a.Ca[c].type.Xa === b) return c;
        return -1
    };
    b.prototype.Lm = function(a, b, c) {
        ...
        if (d = b.ivs)
            for (e in d) d.hasOwnProperty(e) && (f = this.hy(k, parseInt(e, 10)), 0 > f || f >= a.yc.length || (a.yc[f] = d[e]));
        if (g.ah) {
            f = b.w;
            ...
            if (f.hasOwnProperty("fx"))
                for (c = 0, d = f.fx.length; c < d; c++) g = k.Uo(f.fx[c].name), 0 > g || (a.Ig[g] = f.fx[c].active, a.Kb[g] = f.fx[c].params);
            a.gf()
        }
        if (k = b.behs)
            for (e in k) k.hasOwnProperty(e) && (c = this.by(a, parseInt(e, 10)), 0 > c || a.Ca[c].kd(k[e]));
        b.data && a.kd(b.data)
    };
    Hc = function(a) {
...
(function() {
    ...
    a.prototype.Eq = function() {
        ...
        var a, b, d, f, g, l, n;
        a = 0;
        for (d = this.c.da.length; a < d; a++)
            if (b = this.c.da[a], !b.Ea)
        ...
        if (!e)
            for (a = 0, d = this.Ia.length; a < d; ++a) this.Ia[a].G.sort(c);
        J(h);
        this.uw();
        a = 0;
        ...
        if (!this.Qi) {
            for (n in this.kh)
                if (this.kh.hasOwnProperty(n) && (b = this.c.qm(parseInt(n, 10))) && !b.Ea && this.c.Oq(b)) {
                    f = this.kh[n];
                    a = 0;
        ...
        for (a = 0; a < h.length; a++)
            if (l = h[a], l.type.td)
                for (d = l.ek(), b = 0, f = l.type.Ud.length; b < f; b++) n = l.type.Ud[b], l.type !== n && (n.G.length > d ? l.siblings.push(n.G[d]) : n.Be && (g = this.c.Qg(n.Be, l.V, !0, l.x, l.y, !0), this.c.ed(), n.Nn(), l.siblings.push(g), h.push(g)));
        a = 0;
        for (d = this.Zh.length; a < d; a++) this.c.Qg(this.Zh[a], null, !0);
        this.c.Oj = null;
        this.c.ed();
        if (this.c.nb && !this.c.Cb)
            for (a = 0, d = this.c.da.length; a < d; a++) n = this.c.da[a], !n.Ea && n.G.length && n.kq && n.kq(this.c.nb);
        a = 0;
    ...
    a.prototype.eA = function() {
        ...
        var a, b, c, d, f, g;
        if (!this.Qi)
            for (a = 0, b = this.Ia.length; a < b; a++)
                for (this.Ia[a].Sq(), f = this.Ia[a].G, c = 0, d = f.length; c < d; c++) g = f[c], g.type.global || this.c.Oq(g.type) && this.Sz(g);
        a = 0;
        ...
        for (b = this.c.da.length; a < b; a++)
            if (f = this.c.da[a], !(f.global || f.pb.ah || f.pb.zn || f.Ea)) {
                c = 0;
    ...
    a.prototype.pm = function(a) {
        ...
        for (c = this.Ia.length; b < c; b++)
            if (this.Ia[b].Xa === a) return this.Ia[b];
        return null
    };
    ...
    a.prototype.kd = function(a) {
        ...
        for (c = f.length; b < c; b++)
            if (e = this.To(f[b].name)) e.sc = f[b].active, this.Kb[e.index] = f[b].params;
        this.gf();
        b = a.layers;
    ...
    b.prototype.Sq = function() {
        if (this.wi) {
            ...
            var a, b, c;
            if (this.te)
                for (a = this.Cg, b = this.G.length; a < b; ++a) c = this.G[a], c.kf = a, this.$c.ez(c.Nd);
            else
                for (a = this.Cg, b = this.G.length; a < b; ++a) this.G[a].kf = a;
            this.wi = !1;
            this.Cg = -1
        }
    };
    ...
    b.prototype.kd = function(a) {
        ...
        for (d = e.length; b < d; b++)
            if (a = this.To(e[b].name)) a.sc = e[b].active, this.Kb[a.index] = e[b].params;
        this.gf();
        this.G.sort(c);
        this.wi = !0
    };
...
(function() {
    ...
    function h(a, b, c) {
        ...
        if (8 === c.length)
            for (c = c[7], a = 0, b = c.length; a < b; a++) this.sheet.qs(c[a], this, this.Pe);
        this.Cm = !1;
    ...
    function e(a, b) {
        var c, e, d;
        if (a && (-1 === b.indexOf(a) && b.push(a), a.td))
            for (c = 0, e = a.Ud.length; c < e; c++) d = a.Ud[c], a !== d && -1 === b.indexOf(d) && b.push(d)
    }
    ...
    d.prototype.qs = function(a, b, c) {
        switch (a[0]) {
            case 0:
                a = new Pc(this, b, a);
                if (a.Le)
                    for (c.push(a), c = 0, b = a.Gc.length; c < b; c++) a.Gc[c].trigger && this.rs(a, c);
    ...
    h.prototype.sn = function() {
        var a = this.c.Hc(),
            b;
        a.Dd = 0;
        for (b = this.we.length; a.Dd < b; a.Dd++)
            if (this.we[a.Dd].mc()) return;
        this.Tt()
    };
    ...
    h.prototype.Tt = function() {
        if (this.Pe.length) {
            ...
            this.c.mn(this);
            if (this.ju)
                for (a = 0, b = this.Pe.length; a < b; a++) c = this.Pe[a], (e = !this.In || !this.group && a < d) && this.c.ln(c.wb), c.mc(), e ? this.c.pi(c.wb) : this.c.uo(c.wb);
            else
                for (a = 0, b = this.Pe.length; a < b; a++) this.Pe[a].mc();
            this.c.gn()
        }
    };
    h.prototype.Pz = function() {
        ...
        var b = !1,
            c;
        a.Fc = 0;
        for (c = this.Gc.length; a.Fc < c; a.Fc++)
            if (this.Gc[a.Fc].mc()) b = !0;
    ...
    h.prototype.Mz = function() {
        ...
        var a = this.c.Hc().Fc,
            b = this.c.mn(this);
        if (!this.Le)
            for (b.Fc = a + 1, a = this.Gc.length; b.Fc < a; b.Fc++)
                if (!this.Gc[b.Fc].mc()) {
                    this.c.gn();
                    return
                }
    ...
    h.prototype.Sy = function(a) {
        ...
        if (0 === b) return !0;
        for (--b; 0 <= b; --b)
            if (this.Gc[b].type === a.type) return !1;
        return !0
    };
    Pc = h;
    ...
    g.prototype.vq = function() {
        ...
        var n = l.td,
            ...
            I;
        if (u)
            for (b = 0, d = F.length; b < d; ++b) f = F[b], f.Re || (R[b] = f.get(0));
        else
            for (b = 0, d = F.length; b < d; ++b) R[b] = F[b].get(0);
        if (k.bb) {
            J(k.G);
            J(k.gb);
            I = l.G;
            ...
            for (e = I.length; a < e; ++a) {
                h = I[a];
                if (u)
                    for (b = 0, d = F.length; b < d; ++b) f = F[b], f.Re && (R[b] = f.get(a));
        ...
        for (e = I.length; a < e; ++a) {
            ...
            if (hb(b, T))
                if (U = !0, g) {
                    if (k.G.push(h), n)
                        for (b = 0, d = h.siblings.length; b < d; b++) f = h.siblings[b], f.type.Ma().G.push(f)
                } else {
                    I[c] = h;
                    if (n)
                        for (b = 0, d = h.siblings.length; b < d; b++) f = h.siblings[b], f.type.Ma().G[c] = f;
                    c++
                }
            else if (g) {
                I[c] = h;
                if (n)
                    for (b = 0, d = h.siblings.length; b < d; b++) f = h.siblings[b], f.type.Ma().gb[c] = f;
                c++
            } else if (p && (k.gb.push(h), n))
                for (b = 0, d = h.siblings.length; b < d; b++) f = h.siblings[b], f.type.Ma().gb.push(f)
        }
        Da(I, c);
        if (n)
            for (m = l.Ud, a = 0, e = m.length; a < e; a++) h = m[a].Ma(), g ? Da(h.gb, c) : Da(h.G, c);
        c = U;
        if (g && !U)
            for (a = 0, e = k.G.length; a < e; a++) {
                h = k.G[a];
                if (u)
                    for (b = 0, d = F.length; b < d; b++) f = F[b], f.Re && (R[b] = f.get(a));
    ...
    l.prototype.vq = function() {
        var a = this.type,
            ...
            k, p, n, m, q, t;
        if (e)
            for (p = 0, m = d.length; p < m; ++p) q = d[p], q.Re || (f[p] = q.get(0));
        else
            for (p = 0, m = d.length; p < m; ++p) f[p] = d[p].get(0);
        k = 0;
        for (n = h.length; k < n; ++k) {
            t = h[k];
            if (e)
                for (p = 0, m = d.length; p < m; ++p) q = d[p], q.Re && (f[p] = q.get(k));
    ...
    k.prototype.cc = function() {
        ...
        if (11 === this.type) this.Ph = this.c.gs(this.il, this.fe.parent);
            ...
            for (a = 0, b = this.ri.length; a < b; a++) this.ri[a].cc();
        this.uf && this.uf.cc()
    };
...
M.prototype.kd = function(a) {
    ...
    for (b = a.length; c < b; c++)
        if (e = a[c], l = this.c.Hr[e.ev.toString()]) {
            n = -1;
            d = 0;
            for (f = l.we.length; d < f; d++)
                if (l.we[d].Xa === e.act) {
                    n = d;
                    break
                }
            if (-1 !== n) {
                ...
                for (h in e.sols)
                    if (e.sols.hasOwnProperty(h) && (l = this.c.qm(parseInt(h, 10)))) {
                        n = e.sols[h];
                        k = {
                            tn: n.sa,
                            $f: []
...
(function() {
    ...
    c.prototype.Ru = function(a, b, c, d) {
        if (b && a && (b = this.c.yo(a, b, c, d))) {
            ...
            if (b.td)
                for (c = 0, d = b.siblings.length; c < d; c++) f = b.siblings[c], this.c.trigger(Object.getPrototypeOf(f.type.pb).L.Bi, f);
            this.c.ke--;
            a = a.Ma();
            a.bb = !1;
            J(a.G);
            a.G[0] = b;
            if (b.td)
                for (c = 0, d = b.siblings.length; c < d; c++) f = b.siblings[c], a = f.type.Ma(), a.bb = !1, J(a.G), a.G[0] = f
        }
    };
...
(function() {
    Vb = function(a, b) {
        ...
        f && (k.EA = function(a, b) {
            ...
            for (l = e.length; k < l; k++)
                if (f = e[k], m = eb(f.x, f.y, b, c), 0 === a && m < h || 1 === a && m > h) h = m, g = f;
            d.Nk(g);
            return !0
        }, m.qB = function(a) {
        ...
        d || (k.BA = function(a, b, c) {
            ...
            for (k = d.length; h < k; h++)
                if (e = d[h], l = e.yc[b], 0 === a && l < g || 1 === a && l > g) g = l, f = e;
            c.Nk(f);
            return !0
        }, k.XA = function(a) {
            var b, c, d, e, f;
            if (this.c.lm().wm) {
                f = this.Ma();
                if (f.bb)
                    for (f.bb = !1, J(f.G), J(f.gb), d = this.G, b = 0, c = d.length; b < c; b++) e = d[b], e.uid === a ? f.gb.push(e) : f.G.push(e);
                else {
                    d = b = 0;
            ...
            if (this.Ea)
                for (a = e.type.Jb, b = 0, c = a.length; b < c; b++) {
            ...
            this.Lf && this.Lf();
            if (this.Ca)
                for (a = 0, b = this.Ca.length; a < b; ++a) c = this.Ca[a], c.Lf && c.Lf()
        }), q.GA = function(a) {
            var b = a.oi.G.length,
                c, d, e;
            c = 0;
    ...
    Yb = function(a) {
        if (a && a.td && a.type != this) {
            ...
            for (d = a.siblings.length; b < d; b++)
                if (f = a.siblings[b], f.type == this) return f
        }
        a = this.Ma().Vd();
    ...
    dc = function(a) {
        var b, d, f, h, e, g = 0;
        if (!this.Ea)
            for (b = 0, d = this.Jb.length; b < d; b++)
                for (e = this.Jb[b], f = 0, h = e.gc.length; f < h; f++) {
    ...
    hc = function() {
        if (this.td && !this.Ea) {
            ...
            for (b = this.Ud.length; a < b; a++)
                if (h = this.Ud[a], h !== this && (h.Nn(), g = h.Ma(), g.bb = l, !l)) {
                    J(g.G);
                    d = 0;
                    for (f = e.G.length; d < f; ++d) g.G[d] = h.Vo(e.G[d].Xh);
                    if (n)
                        for (J(g.gb), d = 0, f = e.gb.length; d < f; ++d) g.gb[d] = h.Vo(e.gb[d].Xh)
                }
        }
    };
    jc = function() {
...
function od(a) {
    ...
    function E(a, b) {
        ...
        if (ca.hasOwnProperty(a) && (e = ca[a], e.length))
            for (g = e[0].he(), c = 0, d = e.length; c < d; c++) f = e[c], c + 1 === d ? f.ye(G.destination) : f.ye(e[c + 1].he());
        C(a);
        c = 0;
        ...
        if (this.c.bj && 1 === S || pa) {
            var b = /os\s9/i.test(navigator.userAgent),
                ...
                d = function() {
                    ...
                    if (pa) {
                        if (!I)
                            for (a = 0, b = ub.length; a < b; ++a) c = ub[a], c.de || c.Wd || c.U.play();
                        J(ub)
                    }
                };
    ...
    Fa.kd = function(a) {
        ...
        if (3 !== this.pg)
            for (d = 0, e = F.length; d < e; d++) w = F[d], w.Ze && 1 === this.pg || (w.Ze || 2 !== this.pg) && w.stop();
        for (h in ca)
            if (ca.hasOwnProperty(h))
                for (d = 0, e = ca[h].length; d < e; d++) ca[h][d].remove();
        pb(ca);
        for (h in a.effects)
            if (a.effects.hasOwnProperty(h))
                for (D = a.effects[h], d = 0, e = D.length; d < e; d++) switch (f = D[d].type, x = D[d].params, f) {
                    case "filter":
    ...
    Fa.Sb = function() {
        ...
        for (e in ca)
            if (ca.hasOwnProperty(e))
                for (d = ca[e], b = 0, c = d.length; b < c; b++) f = d[b], f.Sb && f.Sb();
    ...
    Fa.Wz = function(a) {
        ...
        for (c = a.length; b < c; ++b)
            if (d = a[b], e = d[0], d = 2 * d[1], (f = 4 < e.length && ".ogg" === e.substr(e.length - 4)) && T || !f && !T) Jb.push({
                filename: e,
                size: d,
                Aa: null
            }), g += d;
    ...
    Fa.Po = function(a, b, c, d, e) {
        ...
        for (g = F.length; f < g; f++)
            if (h = F[f], h.src === a && (h.xw() || c)) return h.tag = b, h;
        a = this.jm(a, c);
...
function nd(a) {
    ...
    m.qa = function() {
        ...
        for (b = this.type.Ed.length; a < b; a++)
            for (e = this.type.Ed[a], c = 0, d = e.frames.length; c < d; c++) f = e.frames[c], 0 === f.width && (f.width = f.Gb.width, f.height = f.Gb.height), f.uj && (h = f.Gb, g = f.Cq, g.left = f.lj / h.width, g.top = f.mj / h.height, g.right = (f.lj + f.width) / h.width, g.bottom = (f.mj + f.height) / h.height, 0 === f.lj && 0 === f.mj && f.width === h.width && f.height === h.height && (f.uj = !1));
    ...
    m.ds = function(a) {
        var b, c, d;
        b = 0;
        for (c = this.type.Ed.length; b < c; b++)
            if (d = this.type.Ed[b], Sb(d.name, a)) return d;
        return null
    };
    m.ay = function(a) {
        var b, c, d;
        b = 0;
        for (c = this.type.Ed.length; b < c; b++)
            if (d = this.type.Ed[b], d.Xa === a) return d;
        return null
    };
    m.Tr = function() {
        var a = this.rb.frames[this.ka],
        ...
        if (r) {
            if (a) {
                ...
                if (a.bb) {
                    ...
                    if (b)
                        for (J(a.gb), d = 0, e = u.G.length; d < e; ++d) c = u.G[d], v.contains(c) || a.gb.push(c)
                } else if (b)
                    for (b = a.G.length, d = 0, e = c.length; d < e; ++d) a.G[b + d] = c[d], La(a.gb, c[d]);
                else Ha(a.G, c);
                u.xe()
            }
            v.clear();
    ...
    g.prototype.Zv = function(a, b, c) {
        if (a && b && (b = this.c.yo(a, b, this.Fe(c, !0), this.Fe(c, !1)))) {
            ...
            this.c.trigger(Object.getPrototypeOf(a.pb).L.Bi, b);
            if (b.td)
                for (d = 0, e = b.siblings.length; d < e; d++) f = b.siblings[d], this.c.trigger(Object.getPrototypeOf(f.type.pb).L.Bi, f);
            this.c.ke--;
            d = this.c.cy();
            c = !1;
            if (ia(d.fa.Spawn_LastExec) || d.fa.Spawn_LastExec < this.c.Qh) c = !0, d.fa.Spawn_LastExec = this.c.Qh;
            if (a != this.type && (a = a.Ma(), a.bb = !1, c ? (J(a.G), a.G[0] = b) : a.G.push(b), b.td))
                for (d = 0, e = b.siblings.length; d < e; d++) f = b.siblings[d], a = f.type.Ma(), a.bb = !1, c ? (J(a.G), a.G[0] = f) : a.G.push(f)
        }
    };
...
function sd(a) {
    ...
    h.De = function(a) {
        ...
        if (this.text && (this.Pt(), !(this.height < this.Mg * this.Ng + this.lineHeight))) {
            ...
            for (var c = b.oc + c, b = b.pc + d, G, n = n * qa(0, this.height - P), L, F, P = 0; P < H.length; P++)
                if (d = H[P].text, G = O = l * qa(0, this.width - H[P].width), n += x, 0 === k && b + n + w < f) n += w;
                else {
...
function td(a) {
    ...
    e.qt = function(a) {
        ...
        for (d = a.changedTouches.length; c < d; c++)
            if (e = a.changedTouches[c], f = this.Zj(e.identifier), 0 <= f) {
    ...
    e.tt = function(a) {
        ...
        for (e = a.changedTouches.length; d < e; d++)
            if (f = a.changedTouches[d], h = this.Zj(f.identifier), -1 === h) {
                h = f.pageX - b.left;
                var k = f.pageY - b.top;
                this.If = this.touches.length;
    ...
    d.prototype.dv = function(a) {
        ...
        for (g = c.length; f < g; f++) {
            ...
            for (k = this.touches.length; h < k; h++)
                if (e = this.touches[h], d = l.V.Vb(e.x, e.y, !0), e = l.V.Vb(e.x, e.y, !1), l.gd(d, e)) {
                    u.push(l);
                    break
                }
        }
...
function Te(a, c, b, d) {
    ...
    if (g > e && g > n)
        for (k = h, m = g;;)
            if (f = k - 1, 0 > f && (f = a.hb - 1), e = Se(a, c, f, b, d), e > m) k = f, m = e;
            else break;
    else if (n > e)
        for (k = l, m = n;;)
            if (f = k + 1, f >= a.hb && (f = 0), e = Se(a, c, f, b, d), e > m) k = f, m = e;
            else break;
    else k = f, m = e;
    return {
        Gr: k,
...
function Ue(a, c, b) {
    ...
    for (f = 0; 20 > f;) {
        ...
        for (e = 0; e < h.length; e++)
            if (d.T[d.j].Wb == h[e].Wb && d.T[d.j].Xb == h[e].Xb) {
                g = !0;
                break
            }
        if (g) break;
...
function df(a, c) {
    if (null === a.j) a.j = c, a.j.parent = null;
        ...
        Qe(d.Qa, c.Qa, b.Qa);
        if (f)
            for (b.parent.Fd == b ? f.Fd = d : f.tf = d, d.Fd = b, d.tf = c, b.parent = d, c.parent = d; f && !Pe(f.Qa, d.Qa);) Qe(f.Qa, f.Fd.Qa, f.tf.Qa), d = f, f = f.parent;
...
function bf(a, c) {
    if (c == a.j) a.j = null;
        ...
        f = b.Fd == c ? b.tf : b.Fd;
        if (d)
            for (d.Fd == b ? d.Fd = f : d.tf = f, f.parent = d; d;) {
                f = d.Qa;
...
function eg(a, c) {
    ...
    for (var b = a.Db; b; b = b.next)
        if (b.ne == c && 0 == b.dg.Zs) return !1;
    return !0
}
y.Dg = function(a) {
    this.m.Dg(a);
...
function Eg(a, c) {
    if (null != a.ea)
        for (var b = 0; b < a.u.length; ++b)
            for (var d = c[b], f = new sg, h = 0; h < d.I; ++h) f.j[h] = d.u[h].Ob, f.k[h] = d.u[h].Hf
}
...
function Ng(a, c) {
    ...
    var d = c.j,
        f = c.k;
    if (!c.O)
        for (var h = f.Gd.eb(xg); h; h = h.Pa()) Ug(h.tc, f) == d && (h.tc.Yj = !0);
    return b
}
...
function Mg(a, c) {
    ...
    a.K--;
    if (!b)
        for (b = f.Gd.eb(xg); b; b = b.Pa()) Ug(b.tc, f) == d && (b.tc.Yj = !0)
}
    ...
    if (0 < h.Ha) {
        ...
        for (u = this.xh.eb(mg); u; u = u.Pa()) {
            ...
            if (!z.tb) {
                ...
                for (var Jb = G.C, gb = 0; gb < Jb.k; ++gb)
                    for (var Le = Jb.j[gb], xi = Le.ea, Dd = 0; Dd < Le.I; ++Dd) {
                        var Og = xi.pa[Dd],
                            Pg = Le.u[Dd];
                        Og.li = Pg.Ob;
                        Og.mi = Pg.Hf
                ...
                if (K) {
                    ...
                    if (.5 <= $d)
                        for (var uf = 0; uf < Zd.k.length; uf++) Zf(Zd.k[uf], !1)
                }
            }
        }
        ...
        for (;;) {
            ...
            if (Ob.I || !Ob.enabled) gd.m.Set(kh), hd.m.Set(lh), dg(gd), dg(hd);
                ...
                var id = Wg;
                id.push(me);
                for (me.tb = !0; 0 < id.length;)
                    if (wb = id.pop(), Fg(va, wb), wb.Yd || Zf(wb, !0), 2 == wb.Pc()) {
                ...
                for (Xa = 0; Xa < Wa.ll; ++Xa)
                    for (Zg(Gf), Pb = 0; Pb < cb.j.length; ++Pb) cb.j[Pb].of(Wa);
                ...
                Eg(cb, Gf.j);
                for (var Ga = 0; Ga < va.k.length; Ga++)
                    if (va.k[Ga].tb = !1, va.k[Ga].Yd && 2 == va.k[Ga].Pc())
                        for (bg(va.k[Ga]), Ja = va.k[Ga].Gd.eb(xg); Ja; Ja = Ja.Pa()) Ja.tc.j = null;
...
function Vg(a, c) {
    ...
    if (a.I) {
        ...
        if (e)
            for (a.u(), d = 0 < a.le.Nb, e = 0; e < a.le.Nb; e++) {
                g = a.le.pa[e];
                g.li = 0;
...
function Zg(a) {
    for (var c = 0; c < a.k; c++) {
        ...
        if (1 == b.I) h = b.u[0], e = h.Ob - h.gg * ((b.k.A.x - b.k.J * h.Fb.y - b.j.A.x + b.j.J * h.Eb.y) * d + (b.k.A.y + b.k.J * h.Fb.x - b.j.A.y - b.j.J * h.Eb.x) * f - h.kl), e = 0 < e ? e : 0, g = e - h.Ob, d = g * d, f = g * f, b.j.A.x -= b.j.N * d, b.j.A.y -= b.j.N * f, b.j.J -= b.j.W * (h.Eb.x * f - h.Eb.y * d), b.k.A.x += b.k.N * d, b.k.A.y += b.k.N * f, b.k.J += b.k.W * (h.Fb.x * f - h.Fb.y * d), h.Ob = e;
            ...
            for (h = b.u[0], e = b.u[1], g = h.Ob, n = e.Ob, k = (b.k.A.x - b.k.J * h.Fb.y - b.j.A.x + b.j.J * h.Eb.y) * d + (b.k.A.y + b.k.J * h.Fb.x - b.j.A.y - b.j.J * h.Eb.x) * f - h.kl, f = (b.k.A.x - b.k.J * e.Fb.y - b.j.A.x + b.j.J * e.Eb.y) * d + (b.k.A.y + b.k.J * e.Fb.x - b.j.A.y - b.j.J * e.Eb.x) * f - e.kl, k -= b.K.n.x * g + b.K.q.x * n, f -= b.K.n.y * g + b.K.q.y * n;;) {
...
ji.prototype.Hg = function() {
    for (var a = null, c = null, b = 0, d = null, f = null, h = 0, e = 0, g = 0, h = null, l = this.j.eb(hg); l; l = l.Pa())
        for (var a = l.body, c = a.m.D, b = a.X, n = this.j.eb(hg); n; n = n.Pa())
            if (d = n.body, a.Yd || d.Yd) f = d.m.D, h = f.x - c.x, e = f.y - c.y, g = h * h + e * e, g < Number.MIN_VALUE || (h = Z(h, e), h.ee(1 / g / Math.sqrt(g) * b * d.X), a.Yd && a.wh(h, c), h.ee(-1), d.Yd && d.wh(h, f), ue(h))
};
...
wi.prototype.nf = function() {
    ...
    if (this.Ch) {
        ...
        .01 > Math.abs(this.Qc - this.rc) ? (p = Rd(v, -.2, .2), m = Math.abs(v), l = !0) : v <= this.rc ? (p = Rd(v - this.rc + .005, -.2, 0), m = this.rc - v, l = !0) : v >= this.Qc && (p = Rd(v - this.Qc + .005, 0, .2), m = v - this.Qc, l = !0)
    }
    this.K = Md(t, this.Sd);
...
Ai.prototype.nf = function() {
    ...
    if (this.Ch) {
        ...
        var v = this.K.x * e + this.K.y * g;
        .01 > Math.abs(this.Qc - this.rc) ? (q = Rd(v, -.2, .2), k = Math.abs(v), l = !0) : v <= this.rc ? (q = Rd(v - this.rc + .005, -.2, 0), k = this.rc - v, l = !0) : v >= this.Qc && (q = Rd(v - this.Qc + .005, 0, .2), k = v - this.Qc, l = !0)
    }
...
Ci.prototype.mf = function(a) {
    ...
    d = ve(this.j);
    e = ve(this.k);
    .005 < d ? this.j.ee(1 / d) : this.j.ta();
    .005 < e ? this.k.ee(1 / e) : this.k.ta();
...
function Ti(a) {
    ...
    for (D.push(a); D.length;) {
        ...
        z = !0;
        for (b = 0; b < d; b++)
            if (n = b, k = b < d - 1 ? b + 1 : b + 1 - d, h = b < d - 2 ? b + 2 : b + 2 - d, a = c[n], m = c[k], q = c[h], h = a.x, f = a.y, l = m.x, e = m.y, g = q.x, q = q.y, h = h * e + l * q + g * f - f * l - e * g - q * h, 0 > h) {
                z = !1;
                l = 1E9;
                for (f = 0; f < d; f++)
                    if (f !== n && f !== k) {
                ...
                v = u.y;
                r = p.y;
                .1 > Math.abs(p.x - u.x) && .1 > Math.abs(r - v) || l.push(u);
                r = -1;
                for (v = n;;) {
                    if (v !== h) f.push(c[v]);
                    else {
...
function Ui(a) {
    ...
    b.xo = function() {
        if (this.enabled) {
            ...
            if (0 === l)
                if (a.ug)
                    for (B = a.Bb.gh() - a.x, t = a.Bb.hh() - a.y, a.zB(d), u = [], l = 0, n = d.length; l < n; ++l) {
                        r = d[l];
                        z = r.Fz;
                        if (r.Bf) {
                            if (!r.Bf.Ol) {
            ...
            this.zp = a.height;
            if (b)
                for (Yf(this.body, c), this.body.tl(g), ue(c), this.rq(), u = this.bg.jf(), l = 0, n = u.length; l < n; l++) v = u[l].fa.Td.sf, v.rq();
            d.length = 0
        }
    };
    b.Sb = function() {
        if (this.enabled) {
            ...
            l = l.y / .02;
            n = this.body.yh();
            if (b !== a.x || l !== a.y || n !== a.M)
                if (a.x = b, a.y = l, a.M = n, a.ra(), a.Ua(), b = a.Bb.gh() - a.x, l = a.Bb.hh() - a.y, 0 !== b || 0 !== l) a.x -= b, a.y -= l, a.ra();
            this.Dm = a.x;
            this.Em = a.y;
            this.xf = a.M
        }
