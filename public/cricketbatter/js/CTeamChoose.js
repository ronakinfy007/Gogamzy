function CTeamChoose() {
    ...
    this._init = function() {
        ...
        _pStartPosContinue = {
            x: CANVAS_WIDTH * 0.5 + 300,
            y: CANVAS_HEIGHT * 0.5 + 400
        };
    ...
    this._createFlag = function(i, iOffsetX, iOffsetY, iTimeWait, iTimeAnim, oFunction, oContainer) {
        ...
        createjs.Tween.get(oButtonFlag).wait(iTimeWait).to({
            scaleY: 1,
            scaleX: 1
        }, iTimeAnim, createjs.Ease.elasticOut);
    ...
    this.loadingScreen = function() {
        ...
        createjs.Tween.get(oContainerLoad).to({
            alpha: 1
