...
var LSprite = (function() {
    ...
    var p = {
        ...
        getWidth: function(maskSize) {
            var s = this,
                i, l, o, a, b, mx, mw, left = s.graphics.startX(),
                right = left + s.graphics.getWidth();
        ...
        getHeight: function(maskSize) {
            var s = this,
                i, l, o, a, b, my, mh, top = s.graphics.startY(),
                bottom = top + s.graphics.getHeight();
            for (i = 0, l = s.childList.length; i < l; i++) {
                o = s.childList[i];
                if (typeof o.visible == UNDEFINED || !o.visible) {
...
var LAnimation = (function() {
    ...
    var p = {
        ...
        clone: function() {
            var s = this,
                a = new LAnimation(null, s.bitmap.bitmapData, s.imageArray.slice(0));
            a.copyProperty(s);
            a.childList.length = 0;
...
var LAnimationTimeline = (function() {
    ...
    var p = {
        clone: function() {
            var s = this,
                k, o, a = new LAnimation(null, s.bitmap.bitmapData, s.imageArray.slice(0));
            a.copyProperty(s);
            a.childList.length = 0;
            a.bitmap = s.bitmap.clone();
            a.addChild(a.bitmap);
